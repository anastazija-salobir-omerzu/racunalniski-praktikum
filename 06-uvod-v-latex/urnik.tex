...
\usepackage{amsmath}  % dodaj v preambulo
...
kakovost urnika:
\[ k \cdot u_1 + k_2 \cdot u_2 + k_3 \cdot u_3 + ... + k_{n-1} \cdot u_{n-1} + k_n \cdot u_n\]
...
V 2.\ oglavju bomo opisali postopek gradnje urnika, saj bomo podrobneje spoznali
...
\section{
Avtomatizirana izdelava urnika}

V 1.\ oglavju smo izvedeli, da ročna izdela urnikov ni tako preprosta, kot bi si
